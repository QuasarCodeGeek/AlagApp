    ...
    <ion-footer>
      <ion-toolbar color="success">
        <ion-buttons v-for="pet in petProfile" :key="pet.petid">
          ...
          <ion-button fill="clear" :href="/inactive/+pet.petid" active><strong>Inactive</strong></ion-button>
          <ion-button fill="clear" :href="/history/+pet.petid" >History</ion-button>
        </ion-buttons>
      </ion-toolbar>
    </ion-footer>
  </ion-app>
...
export default defineComponent({
  ...
  components: {
    ...
    getCard() {
        axios.post("http://localhost/_alagapp/_inactive.php", null, {params: {
              "petid":this.petid
          }})
      .then((response)=>{
