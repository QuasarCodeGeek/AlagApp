...
<div class="row">
        <div class="col-xl-2 col-lg-2 col-md-3 col-sm-3 vh-100 d-none d-sm-block">
    ...
    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 d-block"><!-- Pet Profile -->
        <div class="m-2 p-2">
            <?php
                    ...
                    <div class='card m-2 p-3' style='background-color:#E8F5E9;'>
                      <div class='row'>
                        <div class='col-12 col-xl-4'>
                            <img class='mb-2 rounded' style='width: 20rem;' src='../assets/img/".$petrow['pettype']."/".$petrow['petbreed'].".jpg' alt='petProfile'>
                        </div>
                        <div class='col-12 col-xl-8 p-2 rounded bg bg-light'>
                                ...
                                echo "<div class='card card-body m-2'>
                                  <div class='row'>
                                    <div class='col'>
                                        ...
                                        <label>Weight(Kg): ".$cardrow['cweight']."</label>
                                    </div>
                                    <div class='col '>
                                        <label class='float-end'>Veterinarian: ".$cardrow['cvet']."</label><br>
                                        <label class='float-end'>Date: ".$cardrow['cdate']."</label>
                                    </div>
                                  </div>
                                </div>";
                                $j++;
                        ...
                        echo "<div class='col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12'><!-- Prescription Note -->
                            ...
                            echo "<div class='card card-body m-2'>
                                    <div class='row'>
                                        ...
                                        <div class='col mb-2'>
                                          <label class='float-end'>Date Issued: ".$noterow['ndate']."</label>
                                        </div>
                                    </div>
