...
<form method="POST" action="api/sched/editSched.php">
    ...
    <div class="form-group">
        ...
        <input name="petid" class="form-control" value="<?php echo $petid; ?>" readonly hidden>
        <input name="petname" class="form-control" value="<?php echo $pet; ?>" readonly>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input name="date" class="form-control" type="text" value="<?php echo $date; ?>">
    </div>
    <div class="form-group">
