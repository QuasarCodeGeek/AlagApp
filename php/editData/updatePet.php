    ...
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <main class="container container-fluid">
        <div class="row">
            ...
            <div class="col-9 container p-2 bg bg-dark">
                <div class="row m-2 p-2 bg bg-danger rounded" id="userProfile">
                  <!-- User Account profile Here -->
                </div>
                <div class="row m-2 p-2 bg bg-warning rounded" id="petProfile">
