  ...
  <div class="row m-auto">
        ...
        <div class="col-2 vh-100 bg bg-success"><!--SideBar-->
          ...
          <div class="row m-auto text-center my-3">
            <a class="nav-link text-white" href="dashboard.php" active><h5><i class="bi bi-speedometer2"></i> Dashboard</h5></a> 
          </div>
          <div class="row m-auto text-center my-3">
        ...
        <div class="col-10 vh-100 overflow-auto overflow-y"><!--Main Panel-->
              <div class="row m-auto">
                <div class="row m-auto">
