...
<div class="row m-auto mb-2">
            ...
            <div class="col text-center p-1  bg bg-success rounded-pill">
              <a type="button" class="text-white fw-bold nav-link" href="symptomDashboard.php">Symptoms Diagnosis</a>
            </div>
          </div>
          </div>
          
  <div class="row m-auto border border-3 border-success rounded m-2 p-2"><!-- Pet Symptoms -->
    <div class="row m-auto">
        <div class="col-2 m-auto">
          <label class="fw-bold text-success">Total Records: <?php echo $rowdata['count'];?></label>
        </div>
        <div class="col-4">
          <div class="row">
            <div class="col">
              <input class="form-control w-100" id="symptom" type="text">
            </div>
            <div class="col">
        ...
        <div class="col-3 btn-group" role="group">
          <button type="button" class="btn btn-success" onclick="window.location='symptomDashboard.php'"><i class="bi bi-sort-down"></i> ASC</button>
    ...
    <div class="row m-auto" id="alter">
      ...
      <table class="table table-striped m-2" id="tblSymptom">
        ...
        <tbody>
        <?php
          $symptom = "SELECT * FROM alagapp_db.tbl_symptom ORDER BY sid DESC";
...
document.getElementById("ExportTable").addEventListener('click', function() {
  ...
  var wb = XLSX.utils.table_to_book(document.getElementById("tblSymptom"));
  /* Export to file (start a download) */
  XLSX.writeFile(wb, "Symptom List Summary.xlsx");
});
</script>
</body>
</html>