...
<div class="col-10 vh-100 overflow-auto overflow-y">
  <div class="row m-auto mb-2">
            ...
            <div class="col text-center p-1 bg bg-success">
              <a type="button" class="text-white nav-link" href="userDashboard.php"><strong>User List</strong></a>
            </div>
            <div class="col text-center p-1" style="background-color: #81C784;">
            ...
            <div class="col text-center p-1" style="background-color: #81C784;">
              <a type="button" class="text-white nav-link" href="schedDashboard.php">Consultation</a>
            </div>
            <div class="col text-center p-1"  style="background-color: #81C784;">
  ...
  <div class="row m-auto border border-3 border-success rounded m-2 p-2"><!-- Pet List -->
    <div class="row m-auto">
        ...
        <div class="col">
          <button class="btn btn-success float-end" onclick="window.location='dlUser.php'" target="_blank"><i class="bi bi-download"></i> Download</button>
        </div>
    </div>
