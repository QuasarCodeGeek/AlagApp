...
<div class="col-10 vh-100 overflow-auto overflow-y">
          <div class="row m-auto mb-2">
            ...
            <div class="col text-center p-1 bg bg-success rounded-pill">
              <a type="button" class="text-white fw-bold nav-link" href="noteDashboard.php">Prescription Note</a>
            </div>
            <div class="col text-center p-1">
  ...
  <div class="row m-auto border border-3 border-success rounded m-2 p-2"><!-- Prescription Note -->
      <div class="row m-auto">
        <div class="col-2 m-auto">
          <label class="fw-bold text-success">Total Prescriptions: <?php echo $rowdata['count'];?></label>
        </div>
        <div class="col-6">
          <div class="row">
            <div class="col">
              <input class="form-control w-100" id="note" type="text">
            </div>
            <div class="col">
      ...
      <table class="table table-striped m-2" id="tblNote">
...
document.getElementById("ExportTable").addEventListener('click', function() {
  ...
  var wb = XLSX.utils.table_to_book(document.getElementById("tblNote"));
  /* Export to file (start a download) */
  XLSX.writeFile(wb, "Prescription Note Summary.xlsx");
});
</script>
</body>
</html>