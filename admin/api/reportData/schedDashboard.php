...
<div class="col-10 vh-100 overflow-auto overflow-y">
    ...
    <div class="row m-auto border border-3 border-success rounded m-2 p-2"><!-- Vaccine Card -->
      ...
      <table class="table table-striped m-2" id="tblSched">
...
document.getElementById("ExportTable").addEventListener('click', function() {
  ...
  var wb = XLSX.utils.table_to_book(document.getElementById("tblSched"));
  /* Export to file (start a download) */
  XLSX.writeFile(wb, "Scheduler Summary.xlsx");
});
</script>
</body>
</html>