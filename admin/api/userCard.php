    ...
    if($res->rowCount()>0){
        ...
        while($row = $res->fetch(PDO::FETCH_ASSOC)){
            echo "<div class='col-3'>
                <div class='card bg bg-light border border-3 border-success rounded-pill m-2' style='width:18rem;'>
                    <a type='button' class='btn' href='api/profile.php?userid=".$row['userid']."'>
                    <div class='row m-auto'>
                        ...
                        <div class='col-8 card-body m-auto'>
                            <label class='card-text m-auto text-wrap'><b>".$row['userfname']."</b><br>".$row['userlname']."</label>
                        </div>
                    </div>
                    </a>
                </div>
