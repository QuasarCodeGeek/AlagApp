...
<head>
    ...
    <title>Scheduler Cancelled | AlagApp</title>
...
<!--<nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="modal fade" id="newModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
          ...
          <div class="row m-auto text-center my-5">
                    ...
                    <button class="btn w-100 bg bg-success text-white mb-1 border border-2 border-light rounded" onclick="location.href='schedAccepted.php'">Accepted</button>
                    <button class="btn w-100 bg bg-light border border-3 border-light text-success rounded fw-bold mb-1" onclick="location.href='schedCancelled.php'">Cancelled</button>
  ...
  <div class="col-10 vh-100 vh-100 overflow-auto overflow-y">
    <div class="row m-auto">
      <div class="row m-auto">
                  <h2 class="text-success p-3"><b>Scheduler</b> | Status > Cancelled</h2>
                </div>
