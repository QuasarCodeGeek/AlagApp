...
<head>
    ...
    <title>Scheduler Finished | AlagApp</title>
...
<!--<nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="modal fade" id="newModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
        ...
        <div class="col-2 vh-100 bg bg-success"><!--SideBar-->
          ...
          <div class="row m-auto text-center my-5">
                    ...
                    <button class="btn w-100 bg bg-light border border-3 border-light text-success rounded fw-b-1 border border-2 border-light roubold mb-1" onclick="location.href='schedFinished.php'">Finished</button>
          </div><br><br><br>
  ...
  <div class="col-10 vh-100 overflow-auto overflow-y">
    <div class="row m-auto">
    <div class="row m-auto">
                  <h2 class="text-success p-3"><b>Scheduler</b> | Status > Finished</h2>
                </div>
