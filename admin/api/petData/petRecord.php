...
<?php
                      ...
                      $sql = "SELECT * FROM alagapp_db.tbl_petprofile
                          WHERE userid = ".$petaccount." AND  petid = ".$petid."";
                                    ...
                                    <div class='row mt-2'>
                                      ...
                                      <div class='col-4'>
                                        ...
                                        <div class='row'>
                                          ...
                                          <div class='col'>
                                            <button class='btn btn-primary' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasRight' aria-controls='offcanvasRight'>Medical Record</button>";
                                            include("./petHistory.php");
                                          echo "</div>
                                        </div>
                                      </div>
                                    </div> 
