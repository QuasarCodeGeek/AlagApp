<?php
                      ...
                      if($res->rowCount()>0){
                          ...
                          <div class='col-6'>";
                              if($row['pict'] == ""){
                                echo "<img style='width: 23rem;' id='userProfile' class='rounded m-2' src='../../../assets/default/person.png' alt='profile_picture'>";
                              ...
                              echo "</div>
                              <div class='col-6'>
                                  <div class='row m-auto p-2 rounded bg bg-light'><br>
